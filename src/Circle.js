    ...
    render() {
        ...
        return (
            <div className={`kuma-progress-circle-wrap status-${props.status}`} style={{width: props.size, height: props.size}}>
                ...
                <path className="kuma-progress-circle-trail" d={pathString}
                        strokeWidth={props.trailWidth} fillOpacity="0"/>
                <path className="kuma-progress-circle-path" d={pathString} strokeLinecap="round" strokeWidth={props.strokeWidth} fillOpacity="0" style={pathStyle}/>
                </svg>
                {progressInfo}
            </div>
        );
